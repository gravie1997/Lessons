...
public class Users implements Serializable {
    ...
    public Users(Integer id, String login, String password, String name, String lastname, String email, String phone) {
        this.id = id;
        this.login = login;
    ...
    public String toString() {
        return "com.mycompany.examfinal.domain.entity.Users[ id=" + id + " ]";
    }
